...
export var LANGS = {
  zh: {
    ...
    'blk.var.delta': '帧间隔（Context.delta）', 'blk.var.life': '寿命 tick（Context.life）', 'blk.var.uv': '网格 UV（Context.uv）',
  ...
  en: {
    ...
    'blk.var.delta': 'Frame delta (Context.delta)', 'blk.var.life': 'Life ticks (Context.life)', 'blk.var.uv': 'Grid UV (Context.uv)',
