...
export var LANGS = {
  zh: {
    ...
    'fx.setupBlock': 'Setup（对象初始化一次）', 'fx.processBlock': 'Process（每粒子每帧）', 'fx.seed': '随机种子 ',
    'fx.fastMath': '快速数学近似（process 标量函数）',
  ...
  en: {
    ...
    'fx.setupBlock': 'Setup (runs once per object)', 'fx.processBlock': 'Process (per particle per frame)', 'fx.seed': 'Seed ',
    'fx.fastMath': 'Fast math approximation (process scalar functions)',
