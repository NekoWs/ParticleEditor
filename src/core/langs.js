...
export var LANGS = {
  zh: {
    ...
    'blk.var.index': '当前粒子序号（Context.index）', 'blk.var.count': '粒子总数（Context.count）', 'blk.var.time': '当前时间（Context.time）',
    'blk.var.delta': '帧间隔（Context.delta）', 'blk.var.life': '生命周期进度（Context.life）', 'blk.var.uv': '网格 UV（Context.uv）',
    ...
    // —— 拼图：语句块 ——
    'blk.stmt.pos.label': '位置', 'blk.stmt.pos.desc': '设置 Context.position = [x, y, z]',
    'blk.stmt.pos_vec.label': '位置', 'blk.stmt.pos_vec.desc': '用向量设置 Context.position',
    'blk.stmt.vel.label': '速度', 'blk.stmt.vel.desc': '设置 Context.velocity = [vx, vy, vz]',
    'blk.stmt.vel_vec.label': '速度', 'blk.stmt.vel_vec.desc': '用向量设置 Context.velocity',
    'blk.stmt.col.label': '颜色', 'blk.stmt.col.desc': '设置 Context.color = [r, g, b, a]',
    'blk.stmt.scl.label': '缩放', 'blk.stmt.scl.desc': '设置 Context.scale',
    'blk.stmt.glow.label': '发光', 'blk.stmt.glow.desc': '设置 Context.glow',
    'blk.stmt.light.label': '光照等级', 'blk.stmt.light.desc': '设置 Context.light',
    'blk.stmt.attr.label': '设置属性', 'blk.stmt.attr.desc': '设置 Context 分量（position.x/color.r/…）',
  ...
  en: {
    ...
    'blk.var.index': 'Current particle index (Context.index)', 'blk.var.count': 'Total particles (Context.count)', 'blk.var.time': 'Current time (Context.time)',
    'blk.var.delta': 'Frame delta (Context.delta)', 'blk.var.life': 'Life progress (Context.life)', 'blk.var.uv': 'Grid UV (Context.uv)',
    ...
    // —— 拼图：语句块 ——
    'blk.stmt.pos.label': 'Position', 'blk.stmt.pos.desc': 'Set Context.position = [x, y, z]',
    'blk.stmt.pos_vec.label': 'Position', 'blk.stmt.pos_vec.desc': 'Set Context.position from a vector',
    'blk.stmt.vel.label': 'Velocity', 'blk.stmt.vel.desc': 'Set Context.velocity = [vx, vy, vz]',
    'blk.stmt.vel_vec.label': 'Velocity', 'blk.stmt.vel_vec.desc': 'Set Context.velocity from a vector',
    'blk.stmt.col.label': 'Color', 'blk.stmt.col.desc': 'Set Context.color = [r, g, b, a]',
    'blk.stmt.scl.label': 'Scale', 'blk.stmt.scl.desc': 'Set Context.scale',
    'blk.stmt.glow.label': 'Glow', 'blk.stmt.glow.desc': 'Toggle Context.glow',
    'blk.stmt.light.label': 'Light Level', 'blk.stmt.light.desc': 'Set Context.light',
    'blk.stmt.attr.label': 'Set Property', 'blk.stmt.attr.desc': 'Set a Context component (position.x/color.r/…)',
