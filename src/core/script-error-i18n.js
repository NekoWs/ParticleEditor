...
export const SCRIPT_ERROR_PATTERNS = [
  ...
  { re: /^'process' must not take parameters$/, key: 'err.script.processNoParams' },
  ...
  { re: /^undeclared variable '(.*)'$/, key: 'err.script.undeclaredVariable' },
  { re: /^cannot assign to const '(.*)'$/, key: 'err.script.assignConst' },
  { re: /^duplicate declaration '(.*)'$/, key: 'err.script.duplicateDecl' },
  { re: /^duplicate global '(.*)'$/, key: 'err.script.duplicateGlobal' },
